...
- Необходимо было подумать о ранее созданных документах. При "создании на сервере" проходился по строкам в поиске пустых данных "штрихкод" и если они были, то пытался их получить из "РегистраСведений", после устанавливал "Модифицированность = Истина".
